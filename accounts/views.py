...
def login(request):
    ...
    try:
        ...
        user_data = UserData.objects.create(user=user, mobile_number=phone, is_paid=False)

    # Get or create token
    token, _ = Token.objects.get_or_create(user=user)

    # Check if profile is completed
    profile_completed = bool(user_data.name and user_data.language)
    ...
    # Include user data if profile is completed
